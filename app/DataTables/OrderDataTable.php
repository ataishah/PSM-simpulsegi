...
class OrderDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->orderBy('created_at', 'desc'); // Sort by created_at in descending order
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax()
                    ->orderBy(7, 'desc') // Default sort by the date column (index 7) in descending order
                    ->selectStyleSingle()
                    ->buttons([
                        Button::make('excel'),
                        Button::make('csv'),
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('date'), // Ensure this is sortable
