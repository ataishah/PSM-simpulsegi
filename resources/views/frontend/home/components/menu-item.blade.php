        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_45">
                    ...
                    <h2>Our Available Products Today!</h2>
                    <span>
                        <img src="images/heading_shapes.png" alt="shapes" class="img-fluid w-100">
                    </span>
                    <p>Discover the Best of Malaysia's Local Brands with Zarzou Beauty and Mimpimika. Explore a curated selection of quality products that embody authentic Malaysian excellence. Shop now for skincare and fashion that define local luxury</p>
                </div>
            </div>
        </div>
