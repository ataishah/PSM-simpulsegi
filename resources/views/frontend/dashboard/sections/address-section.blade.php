<div class="tab-pane fade" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
    <div class="fp_dashboard_body address_body">
        ...
        <div class="fp_dashboard_address">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="fp__checkout_single_address">
                            ...
                            <ul>
                                <li><a class="dash_edit_btn" data-class="edit_section_{{ $address->id }}"><i class="far fa-edit"></i></a></li>
            ...
            @foreach ($userAddresses as $address)
            <div class="fp_dashboard_edit_address edit_section_{{ $address->id }} d-none">
                <form action="{{ route('address.update', $address->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="fp__check_single_form check_area">
                                <div class="form-check">
                                    <input @checked($address->type === 'home') class="form-check-input" type="radio" name="type" id="flexRadioDefault1" value="home">
                                    <label class="form-check-label" for="flexRadioDefault1">home</label>
                                </div>
                                <div class="form-check">
                                    <input @checked($address->type === 'office') class="form-check-input" type="radio" name="type" id="flexRadioDefault2" value="office">
                                    <label class="form-check-label" for="flexRadioDefault2">office</label>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function(){
    $('.dash_edit_btn').on('click', function(){
        ...
        $('.fp_dashboard_edit_address').removeClass('d-block').addClass('d-none');
